...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <a href="<?php echo base_url('user/form_sekolah'); ?>"><button class="btn btn-success mb-3">
                    <i class="fas fa-plus"> Tambah Sekolah</i></button></a>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $data->npsn; ?></td>
                            <td>
                                <a href="<?= base_url('user/edit_sekolah/'). $data->id_sekolah?>"><button type="edit"
                                        class="sbtn btn-success"><i class="fas fa-edit"></i></button></a>

                                <a href="<?= base_url('user/hapus_sekolah/'). $data->id_sekolah?>"><button type="delete"
